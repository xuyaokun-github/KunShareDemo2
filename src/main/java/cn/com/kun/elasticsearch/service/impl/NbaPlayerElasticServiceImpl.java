...
//        builder.must(new QueryStringQueryBuilder("XX7475").field("secordCode"));
        ...
        //执行,返回包装结果的分页
        //springboot2.1.6版本对应API  org.springframework.data.domain.Page
//        Page<NbaPlayerDocBean> resutlList = elasticRepository.search(query);

        //2.7.12对应的API
        SearchHits<NbaPlayerDocBean> resutlList = elasticsearchTemplate2.search(query, NbaPlayerDocBean.class);

 ...
 * desc:
*/
public class ManualbeanThirdIntroductionInterceptor implements IntroductionInterceptor, BeanFactoryAware {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        /*
            ...
            类不是完全相同的
         */
        LOGGER.info("ManualbeanThirdIntroductionInterceptor代理前，time:{} method:{}", DateUtils.now(), invocation.getMethod().getName());
        //被代理逻辑
        Object result = invocation.proceed();
        LOGGER.info("ManualbeanThirdIntroductionInterceptor代理后，time:{} method:{}", DateUtils.now(), invocation.getMethod().getName());
        return result;
    }

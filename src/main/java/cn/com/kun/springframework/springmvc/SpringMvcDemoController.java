...
public class SpringMvcDemoController {
     ...
     *
     * swagger3已移除@ApiParam， 解决办法是：consumes = MediaType.MULTIPART_FORM_DATA_VALUE
     * @return CommonResult
     */
    @PostMapping(value = "/upload-by-json", headers="Accept=application/json", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResultVo uploadByJson(String name, @RequestPart
            @RequestParam("file")
    /*@ApiParam(name = "file",value = "file", required = true)*/ //swagger3已移除@ApiParam
